# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-05-15 08:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32)),
                ('roles', models.ManyToManyField(blank=True, null=True, to='iiiedu.Role')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='series',
            name='theme',
            field=models.ManyToManyField(blank=True, null=True, to='iiiedu.Theme'),
        ),
        migrations.AddField(
            model_name='course',
            name='Tag',
        ...
        migrations.AddField(
            model_name='course',
            name='leng',
            field=models.ManyToManyField(blank=True, null=True, to='iiiedu.Leng', verbose_name='語言'),
        ),
        migrations.AddField(
            model_name='course',
            name='series',
            field=models.ManyToManyField(blank=True, null=True, to='iiiedu.Series', verbose_name='領域'),
        ),
    ]
