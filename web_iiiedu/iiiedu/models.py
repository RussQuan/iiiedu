...
class Tag(models.Model):
    ...
    cate = models.ForeignKey("Cate", verbose_name="類別")
...
class Course(models.Model):
    ...
    Tag = models.ForeignKey("Tag", verbose_name="標籤")
    series = models.ManyToManyField("Series", blank=True, null=True, verbose_name="領域")
    leng = models.ManyToManyField("Leng", blank=True, null=True, verbose_name="語言")
